    ...
    <div>
      <div className='flex items-center gap-5 mb-5'>
        <button
          ...
          className='flex items-center gap-2 hover:bg-customgreys-dirtyGrey p-2 border border-customgreys-dirtyGrey rounded-lg text-customgreys-dirtyGrey hover:text-white-100 cursor-pointer'
        >
      ...
      <Form {...methods}>
        <form onSubmit={methods.handleSubmit(onSubmit)}>
          ...
          <div className='flex md:flex-row flex-col justify-between gap-10 mt-5 font-dm-sans'>
            ...
            <div className='bg-customgreys-darkGrey mt-4 md:mt-0 p-4 rounded-lg basis-1/2'>
              <div className='flex justify-between items-center mb-2'>
                <h2 className='font-semibold text-secondary-foreground text-2xl'>
                  Sections
                </h2>
                ...
                >
                  <Plus className='mr-1 w-4 h-4 text-primary-700 group-hover:white-100' />
